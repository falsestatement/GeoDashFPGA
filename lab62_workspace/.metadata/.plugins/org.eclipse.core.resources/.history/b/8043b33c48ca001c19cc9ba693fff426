...
//void setLED(int LED)
//{
//	IOWR_ALTERA_AVALON_PIO_DATA(0x08001140, (IORD_ALTERA_AVALON_PIO_DATA(0x08001140) | (0x001 << LED)));
//}
//
...
//	BYTE tens = 0;
//	BYTE ones = 0;
//	WORD pio_val = IORD_ALTERA_AVALON_PIO_DATA(0x08001150);
//	if (value < 0)
//	{
//		setLED(11);
//		value = -value;
...
//	pio_val |= (ones << 8);
//
//	IOWR_ALTERA_AVALON_PIO_DATA(0x08001150, pio_val);
//}
//
...
//	BYTE tens = 0;
//	BYTE ones = 0;
//	DWORD pio_val = IORD_ALTERA_AVALON_PIO_DATA(0x08001150);
//	if (value < 0)
//	{
//		setLED(10);
//		value = -value;
