	lab62_soc u0 (
		...
		.i2c_serial_out_sda_in          (<connected-to-i2c_serial_out_sda_in>),          //          i2c_serial_out.sda_in
		.i2c_serial_out_scl_in          (<connected-to-i2c_serial_out_scl_in>),          //                        .scl_in
		.i2c_serial_out_sda_oe          (<connected-to-i2c_serial_out_sda_oe>),          //                        .sda_oe
		.i2c_serial_out_scl_oe          (<connected-to-i2c_serial_out_scl_oe>)           //                        .scl_oe
	);
